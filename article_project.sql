...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2019 at 04:55 PM
...
(5, 'Entertainment News', 'Warner Bros has set a 16 December 2022 release date for "Aquaman 2".\r\n"Aquaman 2" is the first titled film to land on 16 December 2022. Disney has already scheduled an untitled live-action movie for the same slot, reported variety.com.\r\nThe studio took the first step toward "Aquaman 2" earlier this month by bringing back David Leslie Johnson-McGoldrick to write the script.\r\n"Aquaman 2" will be produced by "Aquaman" director James Wan and Peter Safran.\r\n"Aquaman" garnered $330 million in North America and $805 million internationally, led by nearly $300 million in China. It is currently the 20th highest worldwide grosser of all time.', 3, 'http://localhost/Article_project/upload/ent.jpg', '09:13:37pm(03-03-19)'),
(6, 'Economy News', 'Asian markets mostly fell Thursday, led by Seoul, as a summit between Donald Trump and Kim Jong Un ended abruptly without an agreement.\r\nEquities had been fluctuating through the day on tempered optimism over China-US trade talks, weak factory data from Beijing and fresh geopolitical tensions in Kashmir.\r\nBut they took a decisive turn south after an expected lunch and signing ceremony between the US and North Korean leaders was called off at the last minute.\r\nThe shock news came just hours after Kim raised the prospect of a permanent US diplomatic presence in Pyongyang and Trump said he was in "no rush" for a speedy deal over North Korea''s nuclear programme.', 3, 'http://localhost/Article_project/upload/political.jpg', '09:18:26pm(03-03-19)');
...
(4, 'mikel56', 'MTIzNA==', 'Mikel', 'Sutradhar', 'mk@gmail.com', 1);
