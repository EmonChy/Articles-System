...
<!--                        <a href="https://wrappixel.com/templates/ampleadmin/" target="_blank" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Upgrade to Pro</a>-->
            ...
            <?php } ?>
                        ...
                        <thead>
                            ...
                            <tr class="bg-inverse">
                                <td><b style="color: white; font-family:monospace">SL</b></td>
                                <td><b style="color: white; font-family: monospace">User Name</b></td>
                                <td><b style="color: white; font-family: monospace">Email</b></td>
                                <td><b style="color: white; font-family: monospace">First Name</b></td>
                                <td><b style="color: white; font-family: monospace" >Last Name</b></td>
                                
                                <td><b style="color: white; font-family: monospace">Status</b></td>
                                <td><b style="color: white; font-family: monospace">Action</b></td>
